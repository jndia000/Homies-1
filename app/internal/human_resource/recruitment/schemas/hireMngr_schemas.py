...
from app.internal.human_resource.recruitment.schemas.recruiter_schemas import ShowJobCategory, ShowApplicant
from app.internal.human_resource.recruitment.schemas.deptMngr_schemas import ShowEmploymentType, ShowPositionForManpowerRequest
