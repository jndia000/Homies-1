...
from app.internal.human_resource.recruitment.schemas.recruiter_schemas import ShowJobCategory
from app.internal.human_resource.recruitment.schemas.deptMngr_schemas \
