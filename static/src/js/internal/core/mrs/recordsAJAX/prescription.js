...
addDrugPrescription = () => {
        ...
        var med_taken_for = $('#med_taken_for').val();
    ...
    if (medication_type == "drug"){
        var data = { medication_name, medication_type, dosage, quantity, frequency, med_taken_for, doc_id, prescription_notes, patient_record_id };
      ...
      var data = { medication_name, medication_type, quantity, doc_id, prescription_notes, patient_record_id };
...
function editPrescriptionModal(prescription_id, type) {
    ...
    $.ajax({
        ...
        success: result => {
            ...
            if (type == 'edit') {
                // set field value
                $("#edit_medication_supply").val(result.medication_name);
                ...
                // set field value
                $("#v_medication_supply").html(result.medication_name);
        ...
        success: result => {
            ...
            if (type == 'edit') {
                ...
                $("#view_prescription_drug").modal('show');
                 ...
                 // set field value
                 $("#pr_drug_name").val(result.medication_name);
                 $("#pr_dosage").val(result.dosage);
                 $("#pr_route").val(result.med_taken_for);
...
editSupplyPrescription = () => {
        ...
        var medication_name = $('#edit_medication_supply').val();
