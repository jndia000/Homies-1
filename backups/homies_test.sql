...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2022 at 06:27 PM
...
INSERT INTO `internal_users` (`id`, `employee_id`, `email`, `password`, `created_at`, `updated_at`) VALUES
...
('48ecc5d8-96cc-11ec-bf1d-6c626d3a5d34', 'b8dfbaa3-96ca-11ec-bf1d-6c626d3a5d34', '48bd11cf-96cc-11ec-bf1d-6c626d3a5d34', NULL, NULL, NULL, '2022-02-26 14:21:08', '2022-02-26 14:21:08'),
...
--
ALTER TABLE `internal_users`
  ADD CONSTRAINT `internal_users_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`);
